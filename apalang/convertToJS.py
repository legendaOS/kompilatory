...
def convertToJS(Ctree: ATLTree) -> str:
    ...
    convertTerminals = {
        ...
        "начало" : "function main(){", "конец":'}; main();', "получить": "getl(", 'вставить': "add(", "продолжить": 'continue'
    }
    ...
    for noda in allNodes[0:-1]:
        ...
        if NType == 'T':
            ...
            if Letter == 'Вставить':
                ...
                stackFunctions.append(' '.join(rightBuf))
                ...
                nbuf = f'{rightBuf[1]} = ВВОД()'
                stack.append(nbuf)

            elif Letter == 'Вывод':
                nbuf = f'ВЫВОД({rightBuf[1]})'
                stack.append(nbuf)
